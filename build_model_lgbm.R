...
save(importance, file = "../MODELS/model_lgb_imp_2.Rdata")
lgb.save(model_lgb, file = "../MODELS/model_lgb_2.model")
rm(x_train, x_test)
gc()
...
write.csv(submission, file = "../SUBMISSION/submission_13_lightgbm.csv", row.names = F)
